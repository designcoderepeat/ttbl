...
export const player_entity = (() => {
  ...
  class BasicCharacterController extends entity.Component {
    ...
    _LoadModels() {
      ...
      loader.setPath('./resources/hero/');
      loader.load('vanguard_t_choonyung.fbx', (fbx) => {
        this._target = fbx;
        this._target.scale.setScalar(0.08);
        ...
        loader.load('dance.fbx', (a) => { _OnLoad('attack', a); });
        loader.load('die.fbx', (a) => { _OnLoad('death', a); });
      });
    }
    ...
    Update(timeInSeconds) {
      ...
      if (input._keys.shift) {
        ...
        // increase skills for walking and running and increase speed
