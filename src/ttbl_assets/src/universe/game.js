...
class BabelUniverse {
    ...
    _Initialize() {
        ...
        this._camera.position.set(175, 20, 0);
        ...
        this._LoadAnimatedModelAndPlay("./resources/", "vanguard_t_choonyung.fbx", "./resources/", "Gangnam Style.fbx", new THREE.Vector3(0, 0, -10));
        this._RAF();
    }

    _LoadAnimatedModelAndPlay(path, modelFile, animPath, animFile, offset) {
